...
def normalize_poses(poses, pts, up_est_method, center_est_method, cam_downscale):
    ...
    # Transformation from RaNeuS
    # get rot matrix to set camera up direction to [0,0,1]
    if cam_downscale:
        print("Cam downscale!")
        R_z = get_rot(z, [0,0,1])
...
class ColmapDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        if stage in [None, 'test']:
            ...
            self.test_dataset = ColmapDataset(self.config, 'train') 
